...
function getCars() {
  ...
  if (data === "" || data === undefined) {
    ...
    for (let index = 0; index < data.length; index++) {
      ...
      htmlData += `<div style="width: 333px; box-shadow: 0px 0px 4px rgba(0, 0, 0, 0.15); border-radius: 8px; padding: 24px; height: fit-content; margin-bottom: 32px;" >
                    <img src=${car.image} alt="${car.manufacture}" style="width: 100%; height: 222px; border-radius: 3px; padding-bottom: 10px" class="card-image-top">
                    ...
                    <button style="margin-top:8px; width: 100%; padding: 8px 0px; background: #5CB85F; border-radius: 3px; border: none; color: white; text-align: center; text-decoration: none; font-family: 'Helvetica';
                    font-style: normal;
                    font-weight: 700;
