      ...
      <div>
        <footer className="bg-white dark:bg-gray-800">
          <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div className="grid grid-cols-4 gap-8 md:grid-cols-4 lg:grid-cols-4">
              <div>
                <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Alamat</h3>
              ...
              <div>
                <h3 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Copyright Binar</h3>
                <div className="w-1/2 px-2 py-4 bg-[#0D28A6]"></div>
              </div>
            </div>
            <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8"></hr>
            <div className="text-center">
              <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2023 Binar™. All Rights Reserved.</span>
            </div>
          </div>
        </footer>
      </div>
